...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{splay}\mathbin{::}(\Conid{Eq}\;\Varid{a})\Rightarrow [\mskip1.5mu \Conid{Bool}\mskip1.5mu]\to (\fun{BTree} \;\Varid{a}\to \fun{BTree} \;\Varid{a}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{discollect}\;\Varid{d}\mathrel{=}\Varid{\Conid{Cp}.cond}\;\Varid{null}\;\Varid{nil}\;(\mathbf{do}\;\{\mskip1.5mu (\Varid{a},\Varid{x})\leftarrow \Varid{head};\Varid{return}\;([\mskip1.5mu (\Varid{a},\Varid{b})\mid \Varid{b}\leftarrow \Varid{x}\mskip1.5mu]\plus (\Varid{discollect}\comp \Varid{tail})\;\Varid{d})\mskip1.5mu\})\;\Varid{d}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{discollectPW}\mathbin{::}(\Conid{Ord}\;\Varid{b},\Conid{Ord}\;\Varid{a})\Rightarrow [\mskip1.5mu (\Varid{b},[\mskip1.5mu \Varid{a}\mskip1.5mu])\mskip1.5mu]\to [\mskip1.5mu (\Varid{b},\Varid{a})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{discollectPW}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{discollectPW}\;((\Varid{a},\Varid{x})\mathbin{:}\Varid{y})\mathrel{=}[\mskip1.5mu (\Varid{a},\Varid{b})\mid \Varid{b}\leftarrow \Varid{x}\mskip1.5mu]\plus \Varid{discollectPW}\;\Varid{y}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
O constituinte g1 será aplicado ao resultado de \ensuremath{\Varid{out}\;(\Conid{Var}\;\Varid{v})}, tendo o seu retorno de ser uma lista com apenas um par em que o primeiro constituinte seria "" e o segundo seria a palavra traduzida a qual chegamos(v).
O constituinte g2 será aplicado a \ensuremath{(\Varid{id}\times\map \;\cata{\Varid{g}})\comp \Varid{out}}, a partir disto facilmente chegamos a conclusão que g2 será aplicado a (v,k) onde k é uma lista do tipo que temos de retornar e são os pares de traduções que se formam a partir daquele termo v, logo tudo o que temos de fazer é inserir v no inicio do primeiro membro de cada um dos pares da lista k concatenada, daí ficamos com \ensuremath{\Varid{g2}\;(\Varid{v},\Varid{k})\mathrel{=}\map \;((\Varid{v}\plus )\times\Varid{id})\;(\Varid{concat}\;\Varid{k})} .
...
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{g1}\mathrel{=}\Varid{singl}\comp \conj{\underline{\text{\ttfamily \char34 \char34}}}{\Varid{id}}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
...
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g1}\;(\Conid{Term}\;\Varid{o}\;\Varid{l})\mid \Varid{o}\equiv \text{\ttfamily \char34 \char34}\mathrel{=}\Varid{auxSequence}\;(\map \;\Varid{g1}\;\Varid{l}){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
...
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g2}\;\anonymous \;\anonymous \mathrel{=}\Conid{Nothing}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\resizebox{5cm}{!}{
  ...
  \xymatrix@C=3cm@R=2cm{
	  \ensuremath{\Conid{String}\times\Conid{Dict}\;^*}
		  \ar[r]^{\ensuremath{\Varid{divideFunction}}}
		  \ar[d]|{\ensuremath{\Varid{anaList\char95 }\;(\Varid{divideFunction})}}
  &
	  \ensuremath{\mathrm{1}\mathbin{+}((\Conid{Dict}\;^*\mathbin{+}(\Conid{Char}\times\Conid{Dict}\;^*))\times(\Conid{String}\times\Conid{Dict}\;^*))}
		  \ar[d]|{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times(\Varid{anaList\char95 }\;\Varid{divideFunction})}}
  \\
	  \ensuremath{(\Conid{Dict}\;^*\mathbin{+}(\Conid{Char}\times\Conid{Dict}\;^*))\;^*}
		  \ar[d]|{\ensuremath{\cata{\Varid{conquerFunction}}}}
		  \ar@/^0.4cm/[r]^-{\ensuremath{\Varid{out}}}
  &
	  \ensuremath{\mathrm{1}\mathbin{+}(\Conid{Dict}\;^*\mathbin{+}(\Conid{Char}\times\Conid{Dict}\;^*))\times(\Conid{Dict}\;^*\mathbin{+}(\Conid{Char}\times\Conid{Dict}\;^*))\;^*}
		  \ar[d]|{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times\cata{\Varid{conquerFunction}}}}
		  \ar@/^0.4cm/[l]^-{\ensuremath{\mathbf{in}}}
  \\
	  \ensuremath{\Conid{Dict}\;^*}
  &
	  \ensuremath{\mathrm{1}\mathbin{+}(\Conid{Dict}\;^*\mathbin{+}(\Conid{Char}\times\Conid{Dict}\;^*))\times\Conid{Dict}\;^*}
		  \ar[l]^{\ensuremath{\Varid{conquerFunction}}}
  }
  \end{eqnarray*}
}
...
\\
\>[B]{}\Varid{divideFunction}\;((\Varid{h}\mathbin{:}\Varid{t}),((\Conid{Term}\;\Varid{k}\;\Varid{v})\mathbin{:}\Varid{ds}))\mid (\Varid{k}\equiv [\mskip1.5mu \Varid{h}\mskip1.5mu])\mathrel{=}i_2\;(i_2\;(\Varid{h},\Varid{ds}),(\Varid{t},\Varid{v})){}\<[E]%
\\
...
\start
%
\ensuremath{\Varid{maisDir}\mathrel{=}\cata{\alt{\Varid{g1}}{\Varid{g2}}}} 
%
\just={lei-43}
%
\ensuremath{\Varid{maisDir}\comp \Varid{inBTree}\mathrel{=}\alt{\Varid{g1}}{\Varid{g2}}\comp \Conid{F}\;\Varid{maisDir}}    
%
\just={def inBTree ; def F }
%
\ensuremath{\Varid{maisDir}\comp \alt{\underline{\Conid{Empty}}}{\Conid{Node}}\mathrel{=}\alt{\Varid{g1}}{\Varid{g2}}\comp (\Varid{id}+(\Varid{id}\times(\Varid{maisDir}\times\Varid{maisDir})))}
%
\just={lei-20 ; lei-22}
%
\ensuremath{\alt{\Varid{maisDir}\comp \underline{\Conid{Empty}}}{\Varid{maisDir}\comp \Conid{Node}}\mathrel{=}\alt{\Varid{g1}}{\Varid{g2}\comp (\Varid{id}\times(\Varid{maisDir}\times\Varid{maisDir}))}}
%
\just={lei-27}
%
\ensuremath{\begin{lcbr}\Varid{maisDir}\comp \underline{\Conid{Empty}}\mathrel{=}\Varid{g1}\\\Varid{maisDir}\comp \Conid{Node}\mathrel{=}\Varid{g2}\comp (\Varid{id}\times(\Varid{maisDir}\times\Varid{maisDir}))\end{lcbr}}
%
\just={inserindo variáveis}
%
\ensuremath{\begin{lcbr}\Varid{maisDir}\comp \underline{\Conid{Empty}}\;()\mathrel{=}\Varid{g1}\;()\\\Varid{maisDir}\comp \Conid{Node}\;(\Varid{a},(\Varid{t1},\Varid{t2}))\mathrel{=}\Varid{g2}\comp (\Varid{id}\times(\Varid{maisDir}\times\Varid{maisDir}))\;(\Varid{a},(\Varid{t1},\Varid{t2}))\end{lcbr}}
%
\just={lei-3 ; lei-75}
%
\ensuremath{\begin{lcbr}\Varid{maisDir}\;\Conid{Empty}\mathrel{=}\Varid{g1}\;()\\\Varid{maisDir}\;(\Conid{Node}\;(\Varid{a},(\Varid{t1},\Varid{t2})))\mathrel{=}\Varid{g2}\comp (\Varid{a},((\Varid{maisDir}\;\Varid{t1}),(\Varid{maisDir}\;\Varid{t2})))\end{lcbr}}
%
 \end{eqnarray*}
...
\\
\>[B]{}\Varid{isNothing}\;(\Conid{Just}\;\Varid{a})\mathrel{=}\Conid{False}{}\<[E]%
\\
...
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{g2}\mathrel{=}\Varid{\Conid{Cp}.cond}\;(\Varid{isNothing}\comp \p2\comp \p2)\;(\Conid{Just}\comp \p1)\;(\p2\comp \p2){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=3.4cm@R=2cm{
	\ensuremath{\fun{BTree} }
		\ar[d]|{\ensuremath{\Varid{maisDir}\mathrel{=}\cata{\Varid{g}}}}
...
&
	\ensuremath{\mathrm{1}\mathbin{+}(\Conid{A}\times(\Conid{Maybe}\;\Conid{A}\times\Conid{Maybe}\;\Conid{A}))}
		\ar[l]^-{\ensuremath{\Varid{g}\mathrel{=}\alt{\Varid{nothing}}{\Varid{\Conid{Cp}.cond}\;(\Varid{isNothing}\comp \p1\comp \p2)\;(\Conid{Just}\comp \p1)\;(\p1\comp \p2)}}}
}
\end{eqnarray*}
...
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{g2}\mathrel{=}\Varid{\Conid{Cp}.cond}\;(\Varid{isNothing}\comp \p1\comp \p2)\;(\Conid{Just}\comp \p1)\;(\p1\comp \p2){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{g}\mathrel{=}\conj{\Varid{hFunc}}{\alt{\underline{\Conid{Empty}}}{\Varid{k2}}}{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{k2}\;(\Varid{a},((\Varid{b1},\Varid{t1}),(\Varid{b2},\Varid{t2})))\mathrel{=}\Conid{Node}\;(\Varid{a},(\Varid{t1},\Varid{t2})){}\<[E]%
\\[\blanklineskip]%
...
\xymatrix@C=3.4cm@R=2cm{
	\ensuremath{\Conid{Bool}\;^*}
		\ar[d]|{\ensuremath{\Varid{splay}\mathrel{=}\cata{\Varid{g}}}}
		\ar@/_0.5cm/[r]_-{\ensuremath{\Varid{out}}}
&
...
\\
	\ensuremath{\fun{BTree} \;^{BTree}}
&
	\ensuremath{\mathrm{1}\mathbin{+}(\Conid{Bool}\times\fun{BTree} \;^{BTree})}
		\ar[l]^-{\ensuremath{\Varid{g}\mathrel{=}\alt{\underline{\Varid{id}}}{\Varid{curry}\;(\Varid{\Conid{Cp}.cond}\;((\Conid{Empty}\equiv )\comp \p2)\;\Varid{func1}\;\Varid{func2})}}}
}
\end{eqnarray*}
...
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{splay}\mathrel{=}\Varid{cataList}\;\alt{\underline{\Varid{id}}}{\Varid{curry}\;(\Varid{\Conid{Cp}.cond}\;((\Conid{Empty}\equiv )\comp \p2)\;\Varid{func1}\;\Varid{func2})}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{func1}\mathrel{=}\Varid{id}\comp \p2{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{func2}\mathrel{=}\Varid{\Conid{Cp}.cond}\;(\p1\comp \p1)\;(\Varid{\Conid{Cp}.ap}\comp (\p2\times\Varid{getNodEsq}))\;(\Varid{\Conid{Cp}.ap}\comp (\p2\times\Varid{getNodDir})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{splayPW}\mathrel{=}\Varid{cataList}\;\alt{\underline{\Varid{id}}}{\Varid{g2}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g2}\;\anonymous \;\Conid{Empty}\mathrel{=}\Conid{Empty}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g2}\;(\Varid{b1},\Varid{sp2})\;(\Conid{Node}\;(\Varid{a},(\Varid{t1},\Varid{t2})))\mid \Varid{b1}\equiv \Conid{True}\mathrel{=}\Varid{sp2}\;\Varid{t1}{}\<[E]%
\\
\>[3]{}\hsindent{31}{}\<[34]%
\>[34]{}\mid \Varid{otherwise}\mathrel{=}\Varid{sp2}\;\Varid{t2}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=3.4cm@R=2cm{
	\ensuremath{\mathsf{LTree}}
		\ar[d]|{\ensuremath{\Varid{navLTree}\mathrel{=}\cata{\Varid{g}}}}
		\ar@/_0.5cm/[r]_-{\ensuremath{\Varid{out}}}
&
	\ensuremath{\Conid{A}\mathbin{+}(\mathsf{LTree}\times\mathsf{LTree})}
		\ar@/_0.5cm/[l]^-{\ensuremath{\mathbf{in}}}
		\ar[d]|{\ensuremath{\Varid{id}\mathbin{+}(\cata{\Varid{g}}\times\cata{\Varid{g}})}}
\\
	\ensuremath{\mathsf{LTree}\;^{Bool^*}}
&
	\ensuremath{\Conid{A}\mathbin{+}\Conid{A}\times(\mathsf{LTree}\;^{Bool^*}\times\mathsf{LTree}\;^{Bool^*})}
		\ar[l]^-{\ensuremath{\Varid{g}\mathrel{=}\alt{\Varid{flip}\;\underline{\Conid{Leaf}}}{\Varid{fFunction}}}}
}
\end{eqnarray*}
...
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g1}\mathrel{=}\Varid{flip}\;\underline{\Conid{Leaf}}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{fFunction}\mathrel{=}\Varid{curry}\;(\Varid{\Conid{Cp}.cond}\;(\Varid{null}\comp \p2)\;\Varid{ff1}\;\Varid{ff2}){}\<[E]%
\\
\>[B]{}\hsindent{11}{}\<[11]%
\>[11]{}\mathbf{where}\;\Varid{ff1}\mathrel{=}\Conid{Fork}\comp \conj{\Varid{\Conid{Cp}.ap}\comp (\p1\times\Varid{nil})}{\Varid{\Conid{Cp}.ap}\comp (\p2\times\Varid{nil})}{}\<[E]%
\\
\>[11]{}\hsindent{6}{}\<[17]%
\>[17]{}\Varid{ff2}\mathrel{=}\Varid{\Conid{Cp}.cond}\;(\Varid{head}\comp \p2)\;(\Varid{\Conid{Cp}.ap}\comp (\p1\times\Varid{tail}))\;(\Varid{\Conid{Cp}.ap}\comp (\p2\times\Varid{tail})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{navLTreePW}\mathbin{::}\mathsf{LTree}\;\Varid{a}\to ([\mskip1.5mu \Conid{Bool}\mskip1.5mu]\to \mathsf{LTree}\;\Varid{a}){}\<[E]%
\\
\>[B]{}\Varid{navLTreePW}\mathrel{=}\Varid{cataLTree}\;\Varid{g}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\Varid{g1}}{\Varid{fFunctionPW}}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g1}\;\Varid{a}\mathrel{=}\underline{(\Conid{Leaf}\;\Varid{a})}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{fFunctionPW}\mathbin{::}(([\mskip1.5mu \Conid{Bool}\mskip1.5mu]\to \mathsf{LTree}\;\Varid{a}),([\mskip1.5mu \Conid{Bool}\mskip1.5mu]\to \mathsf{LTree}\;\Varid{a}))\to [\mskip1.5mu \Conid{Bool}\mskip1.5mu]\to \mathsf{LTree}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{fFunctionPW}\;(\Varid{t1},\Varid{t2})\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}\Conid{Fork}\;((\Varid{t1}\;[\mskip1.5mu \mskip1.5mu]),(\Varid{t2}\;[\mskip1.5mu \mskip1.5mu])){}\<[E]%
\\
\>[B]{}\Varid{fFunctionPW}\;(\Varid{t1},\Varid{t2})\;(\Varid{h}\mathbin{:}\Varid{t})\mid \Varid{h}\mathrel{=}\Varid{t1}\;\Varid{t}{}\<[E]%
\\
\>[B]{}\hsindent{27}{}\<[27]%
\>[27]{}\mid \Varid{otherwise}\mathrel{=}\Varid{t2}\;\Varid{t}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{getNodVal}\mathbin{::}\fun{BTree} \;\Varid{a}\to \Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{getNodVal}\;(\Conid{Node}\;(\Varid{a},(\Varid{t1},\Varid{t2})))\mathrel{=}\Varid{a}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{getNodEsq}\mathbin{::}\fun{BTree} \;\Varid{a}\to \fun{BTree} \;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{getNodEsq}\;(\Conid{Node}\;(\Varid{a},(\Varid{t1},\Varid{t2})))\mathrel{=}\Varid{t1}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{getNodDir}\mathbin{::}\fun{BTree} \;\Varid{a}\to \fun{BTree} \;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{getNodDir}\;(\Conid{Node}\;(\Varid{a},(\Varid{t1},\Varid{t2})))\mathrel{=}\Varid{t2}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=3.4cm@R=2cm{
	\ensuremath{\mathsf{LTree}}
		\ar[d]|{\ensuremath{\Varid{bnavLTree}\mathrel{=}\cata{\Varid{g}}}}
		\ar@/_0.5cm/[r]_-{\ensuremath{\Varid{out}}}
&
	\ensuremath{\Conid{A}\mathbin{+}(\mathsf{LTree}\times\mathsf{LTree})}
		\ar@/_0.5cm/[l]^-{\ensuremath{\mathbf{in}}}
		\ar[d]|{\ensuremath{\Varid{id}\mathbin{+}(\cata{\Varid{g}}\times\cata{\Varid{g}})}}
\\
	\ensuremath{\mathsf{LTree}\;^{BTree}}
&
	\ensuremath{\Conid{A}\mathbin{+}\Conid{A}\times(\mathsf{LTree}\;^{BTree}\times\mathsf{LTree}\;^{BTree})}
		\ar[l]^-{\ensuremath{\Varid{g}\mathrel{=}\alt{\Varid{flip}\;\underline{\Conid{Leaf}}}{\Varid{bfFunction}}}}
}
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\Varid{flip}\;\underline{\Conid{Leaf}}}{\Varid{bfFunction}}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{bfFunction}\mathrel{=}\Varid{curry}\;(\Varid{\Conid{Cp}.cond}\;((\Conid{Empty}\equiv )\comp \p2)\;\Varid{func1}\;\Varid{func2}){}\<[E]%
\\
\>[B]{}\hsindent{13}{}\<[13]%
\>[13]{}\mathbf{where}\;\Varid{func1}\mathrel{=}\Conid{Fork}\comp \conj{\Varid{\Conid{Cp}.ap}\comp (\p1\times\Varid{id})}{\Varid{\Conid{Cp}.ap}\comp (\p2\times\Varid{id})}{}\<[E]%
\\
\>[13]{}\hsindent{6}{}\<[19]%
\>[19]{}\Varid{func2}\mathrel{=}\Varid{\Conid{Cp}.cond}\;(\Varid{getNodVal}\comp \p2)\;(\Varid{\Conid{Cp}.ap}\comp (\p1\times\Varid{getNodEsq}))\;(\Varid{\Conid{Cp}.ap}\comp (\p2\times\Varid{getNodDir})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{bnavLTreePW}\mathrel{=}\Varid{cataLTree}\;\Varid{g}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\Varid{g1}}{\Varid{bfFunctionPW}}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g1}\;\Varid{a}\mathrel{=}\underline{(\Conid{Leaf}\;\Varid{a})}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{bfFunctionPW}\mathbin{::}((\fun{BTree} \;\Conid{Bool}\to \mathsf{LTree}\;\Varid{a}),(\fun{BTree} \;\Conid{Bool}\to \mathsf{LTree}\;\Varid{a}))\to \fun{BTree} \;\Conid{Bool}\to \mathsf{LTree}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{bfFunctionPW}\;(\Varid{t1},\Varid{t2})\;\Conid{Empty}\mathrel{=}\Conid{Fork}\;((\Varid{t1}\;\Conid{Empty}),(\Varid{t2}\;\Conid{Empty})){}\<[E]%
\\
\>[B]{}\Varid{bfFunctionPW}\;(\Varid{t1},\Varid{t2})\;(\Conid{Node}\;(\Varid{a},(\Varid{tt1},\Varid{tt2})))\mid \Varid{a}\mathrel{=}\Varid{t1}\;\Varid{tt1}{}\<[E]%
\\
\>[B]{}\hsindent{43}{}\<[43]%
\>[43]{}\mid \Varid{otherwise}\mathrel{=}\Varid{t2}\;\Varid{tt2}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=3.4cm@R=2cm{
	\ensuremath{\mathsf{LTree}}
		\ar[d]|{\ensuremath{\Varid{pbnavLTree}\mathrel{=}\cata{\Varid{g}}}}
		\ar@/_0.5cm/[r]_-{\ensuremath{\Varid{out}}}
&
	\ensuremath{\Conid{A}\mathbin{+}(\mathsf{LTree}\times\mathsf{LTree})}
		\ar@/_0.5cm/[l]^-{\ensuremath{\mathbf{in}}}
		\ar[d]|{\ensuremath{\Varid{id}\mathbin{+}(\cata{\Varid{g}}\times\cata{\Varid{g}})}}
\\
	\ensuremath{\fun{Dist}\;(\mathsf{LTree})\;^{BTree}}
&
	\ensuremath{\Conid{A}\mathbin{+}\Conid{A}\times(\fun{Dist}\;(\mathsf{LTree})\;^{BTree}\times\fun{Dist}\;(\mathsf{LTree})\;^{BTree})}
		\ar[l]^-{\ensuremath{\Varid{g}\mathrel{=}\alt{\Varid{flip}\;\underline{(\Varid{return}\comp \Conid{Leaf})}}{\Varid{bpfFunction}}}}
}
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\Varid{g1}}{\Varid{pbfFunctionPW}}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g1}\mathrel{=}\Varid{flip}\;\underline{(\Varid{return}\comp \Conid{Leaf})}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{pbfFunctionPW}\;(\Varid{t1},\Varid{t2})\;\Conid{Empty}\mathrel{=}\Varid{\Conid{Probability}.cond}\;(\Varid{choose}\;\mathrm{0.5}\;\Conid{True}\;\Conid{False})\;(\Varid{t1}\;\Conid{Empty})\;(\Varid{t2}\;\Conid{Empty}){}\<[E]%
\\
\>[B]{}\Varid{pbfFunctionPW}\;(\Varid{t1},\Varid{t2})\;(\Conid{Node}\;(\Varid{e},(\Varid{l1},\Varid{l2})))\mathrel{=}\Varid{\Conid{Probability}.cond}\;\Varid{e}\;(\Varid{t1}\;\Varid{l1})\;(\Varid{t2}\;\Varid{l2}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{31}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{decisao}\mathrel{=}{}\<[E]%
\\
\>[B]{}\hsindent{7}{}\<[7]%
\>[7]{}\Conid{Query}\;(\text{\ttfamily \char34 2a-feira?\char34},{}\<[E]%
\\
\>[7]{}\hsindent{2}{}\<[9]%
\>[9]{}((\Conid{Query}\;(\text{\ttfamily \char34 chuva~na~ida?\char34},{}\<[E]%
\\
\>[9]{}\hsindent{6}{}\<[15]%
\>[15]{}((\Conid{Dec}\;\text{\ttfamily \char34 precisa\char34}),{}\<[E]%
\\
\>[9]{}\hsindent{6}{}\<[15]%
\>[15]{}(\Conid{Query}\;(\text{\ttfamily \char34 chuva~na~volta?\char34},{}\<[E]%
\\
\>[15]{}\hsindent{4}{}\<[19]%
\>[19]{}((\Conid{Dec}\;\text{\ttfamily \char34 precisa\char34}),(\Conid{Dec}\;\text{\ttfamily \char34 nao~precisa\char34})))))),{}\<[E]%
\\
\>[7]{}\hsindent{2}{}\<[9]%
\>[9]{}(\Conid{Dec}\;\text{\ttfamily \char34 nao~precisa\char34})))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{bTProbabilidade}\mathrel{=}{}\<[E]%
\\
\>[B]{}\hsindent{17}{}\<[17]%
\>[17]{}\Conid{Node}\;((\Conid{D}\;[\mskip1.5mu (\Conid{True},\mathrm{1}\mathbin{/}\mathrm{7}),(\Conid{False},\mathrm{6}\mathbin{/}\mathrm{7})\mskip1.5mu]),{}\<[E]%
\\
\>[17]{}\hsindent{1}{}\<[18]%
\>[18]{}(\Conid{Node}\;((\Conid{D}\;[\mskip1.5mu (\Conid{True},\mathrm{0.8}),(\Conid{False},\mathrm{0.2})\mskip1.5mu]),{}\<[E]%
\\
\>[18]{}\hsindent{7}{}\<[25]%
\>[25]{}(\Conid{Empty},{}\<[E]%
\\
\>[18]{}\hsindent{7}{}\<[25]%
\>[25]{}\Conid{Node}\;((\Conid{D}\;[\mskip1.5mu (\Conid{True},\mathrm{0.6}),(\Conid{False},\mathrm{0.4})\mskip1.5mu]),{}\<[E]%
\\
\>[25]{}\hsindent{6}{}\<[31]%
\>[31]{}(\Conid{Empty},\Conid{Empty})))),{}\<[E]%
\\
\>[17]{}\hsindent{1}{}\<[18]%
\>[18]{}\Conid{Empty})){}\<[E]%
\ColumnHook
...
\\
\>[B]{}\Varid{draw}\;\Varid{x}\;\Varid{y}\;\Varid{i}\;(\Varid{h}\mathbin{:}\Varid{t})\mathrel{=}(\Varid{put}\;((\Varid{fromIntegral}\;(\Varid{i}\mathbin{*}\mathrm{80}\mathbin{-}\mathrm{480})),(\Varid{fromIntegral}\;(\Varid{y}\mathbin{*}\mathrm{80}\mathbin{-}\mathrm{480})))\;\Varid{h})\mathbin{:}(\Varid{draw}\;\Varid{x}\;\Varid{y}\;(\Varid{i}\mathbin{-}\mathrm{1})\;\Varid{t}){}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{let}\;(\Varid{x},\Varid{y})\mathrel{=}((\Varid{read}\;\Varid{xi}\mathbin{::}\Conid{Int}),(\Varid{read}\;\Varid{yi}\mathbin{::}\Conid{Int})){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{n}\leftarrow \Varid{getStdRandom}\;(\Varid{randomR}\;(\mathrm{0},\Varid{x}\mathbin{*}\Varid{y})){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{l}\leftarrow \Varid{permuta}\;((\Varid{replicate}\;((\Varid{x}\mathbin{*}\Varid{y})\mathbin{-}\Varid{n})\;\Varid{truchet1})\plus (\Varid{replicate}\;\Varid{n}\;\Varid{truchet2})){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{display}\;\Varid{janela}\;\Varid{white}\;(\Conid{Pictures}\;(\Varid{draw}\;\Varid{x}\;\Varid{y}\;\Varid{x}\;\Varid{l})){}\<[E]%
\\[\blanklineskip]%
