...
O constituinte g2 seria aplicado ao resultado de (id >< ( {| cataBTree g |} >< {| cataBTree g |})) .out .(Node a (t1,t2)) simplificando iria ser aplicado a (a,(r1,r2)) sendo r1 = {| cataBtree g |} e r2 = {| cataBTree g |} o que consoante o elemento que queriamos nos retorna o que está abaixo representado.
