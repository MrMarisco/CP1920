...
&
	\ensuremath{\Conid{A}\mathbin{+}\Conid{A}\times(\mathsf{LTree}\;^{Bool^*}\times\mathsf{LTree}\;^{Bool^*})}
		\ar[l]^-{\ensuremath{\Varid{g}\mathrel{=}\alt{\underline{\Conid{Leaf}}}{\Varid{fFunction}}}}
}
\end{eqnarray*}
...
\\
\>[B]{}\Varid{fFunction}\mathrel{=}\Varid{curry}\;(\Varid{\Conid{Cp}.cond}\;(\Varid{null}\comp \p2)\;(\Conid{Fork}\comp \conj{\Varid{\Conid{Cp}.ap}\comp (\p1\times\Varid{nil})}{\Varid{\Conid{Cp}.ap}\comp (\p2\times\Varid{nil})})\;(\Varid{\Conid{Cp}.cond}\;(\Varid{head}\comp \p2)\;(\Varid{\Conid{Cp}.ap}\comp (\p1\times\Varid{tail}))\;(\Varid{\Conid{Cp}.ap}\comp (\p2\times\Varid{tail})))){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&
	\ensuremath{\Conid{A}\mathbin{+}\Conid{A}\times(\mathsf{LTree}\;^{BTree}\times\mathsf{LTree}\;^{BTree})}
		\ar[l]^-{\ensuremath{\Varid{g}\mathrel{=}\alt{\underline{\Conid{Leaf}}}{\Varid{bfFunction}}}}
}
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\underline{\cdot }\comp \Conid{Leaf}}{\Varid{bfFunction}}{}\<[E]%
\\[\blanklineskip]%
...
&
	\ensuremath{\Conid{A}\mathbin{+}\Conid{A}\times(\fun{Dist}\;(\mathsf{LTree})\;^{BTree}\times\fun{Dist}\;(\mathsf{LTree})\;^{BTree})}
		\ar[l]^-{\ensuremath{\Varid{g}\mathrel{=}\alt{\underline{(\Varid{certainly}\comp \Conid{Leaf})}}{\Varid{bpfFunction}}}}
}
...
\\[\blanklineskip]%
\>[B]{}\Varid{pbfFunctionPW}\mathbin{::}((\fun{BTree} \;(\fun{Dist}\;\Conid{Bool})\to \fun{Dist}\;(\mathsf{LTree}\;\Varid{a})),(\fun{BTree} \;(\fun{Dist}\;\Conid{Bool})\to \fun{Dist}\;(\mathsf{LTree}\;\Varid{a})))\to \fun{BTree} \;(\fun{Dist}\;\Conid{Bool})\to \fun{Dist}\;(\mathsf{LTree}\;\Varid{a}){}\<[E]%
\\
...
\column{31}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{decisao}\mathrel{=}\Conid{Query}\;(\text{\ttfamily \char34 2a-feira?\char34},{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{bTProbabilidade}\mathrel{=}\Conid{Node}\;((\Conid{D}\;[\mskip1.5mu (\Conid{True},\mathrm{1}\mathbin{/}\mathrm{7}),(\Conid{False},\mathrm{6}\mathbin{/}\mathrm{7})\mskip1.5mu]),{}\<[E]%
\\
\>[B]{}\hsindent{18}{}\<[18]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{putTiles}\;\Varid{a}\;\Varid{b}\mathrel{=}(\Varid{replicate}\;\Varid{a}\;\Varid{truchet1})\plus (\Varid{replicate}\;\Varid{b}\;\Varid{truchet2}){}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{r}\leftarrow \Varid{permuta}\;(\Varid{putTiles}\;((\Varid{x}\mathbin{*}\Varid{y})\mathbin{-}\Varid{n})\;\Varid{n}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{display}\;\Varid{janela}\;\Varid{white}\;(\Varid{put}\;((\mathbin{-}\mathrm{480}),(\mathbin{-}\mathrm{480}))\;(\Varid{\Conid{Graphics}.\Conid{Gloss}.scale}\;(\mathrm{10}\mathbin{/}\Varid{fromIntegral}\;\Varid{x})\;(\mathrm{10}\mathbin{/}\Varid{fromIntegral}\;\Varid{y})\;(\Conid{Pictures}\;(\Varid{draw}\;\Varid{x}\;\Varid{y}\;\Varid{x}\;\Varid{r})))){}\<[E]%
\\[\blanklineskip]%
