...
\\
\>[B]{}\Varid{discollect}\;\Varid{d}\mathrel{=}\Varid{\Conid{Cp}.cond}\;\Varid{null}\;\Varid{nil}\;(\Varid{head}\bind \lambda (\Varid{a},\Varid{x})\to (\Varid{return}\;([\mskip1.5mu (\Varid{a},\Varid{b})\mid \Varid{b}\leftarrow \Varid{x}\mskip1.5mu]\plus (\Varid{discollect}\comp \Varid{tail})\;\Varid{d})))\;\Varid{d}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[9]{}\hsindent{14}{}\<[23]%
\>[23]{}\mid \Varid{otherwise}\mathrel{=}\Conid{Nothing}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
...
\resizebox{5cm}{!}{
  ...
  \xymatrix@C=3cm@R=2cm{
	  \ensuremath{\Conid{String}\times\Conid{Dict}\;^*}
		  ...
		  \ar[d]|{\ensuremath{\ana{(\Varid{divideFunction})}}}
  &
	  \ensuremath{\mathrm{1}\mathbin{+}((\Conid{Dict}\;^*\mathbin{+}(\Conid{Char}\times\Conid{Dict}\;^*))\times(\Conid{String}\times\Conid{Dict}\;^*))}
		  \ar[d]|{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times(\ana{\Varid{divideFunction}})}}
  \\
...
\\[\blanklineskip]%
\>[B]{}\Varid{pbfFunctionPW}\;(\Varid{t1},\Varid{t2})\;\Conid{Empty}\mathrel{=}{}\<[32]%
\>[32]{}(\bind )\;(\Varid{prod}\;(\Varid{t1}\;\Conid{Empty})\;(\Varid{t2}\;\Conid{Empty}))\;(\Varid{return}\comp \Conid{Fork}){}\<[E]%
\\
